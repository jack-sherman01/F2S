...
def generate_training_cfg(task_config, used_demo, dataset_path_dict, abs_output_dir, seeds, prefix, extra_params_for_dataset=None):
...
def start_evaluating(abs_output_dir, seeds, prefix, eval_specific_args="", eval_output_dir_name="eval", count_only=True, cuda_device=None):
    global n_rollouts
    processes = []
    eval_log_dir_dict = {}
    for i, seed in enumerate(seeds):
...
if __name__ == "__main__":
    ...
    #     for seed in seeds
    # }
    # generate_training_cfg(args.config, "train_success", dataset_path_dict, abs_output_dir, seeds, "round_1")

    # # start training for the second round
    # start_training(abs_output_dir, seeds, "round_1", cuda_device=args.cuda_device)
    ...
    #     for seed in seeds
    # }
    # generate_training_cfg(args.config, "train_success", dataset_path_dict, abs_output_dir, seeds, "round_1_{}".format("ours"))

    # # start training for the second round
    # start_training(abs_output_dir, seeds, "round_1_{}".format("ours"), cuda_device=args.cuda_device)
    ...
    def round_i(i):
        ...
        #     for seed in seeds
        # }
        # generate_training_cfg(args.config, "train_success", dataset_path_dict, abs_output_dir, seeds, "round_{}".format(i))

        # # start training for the next round
        # start_training(abs_output_dir, seeds, "round_{}".format(i), cuda_device=args.cuda_device)
        ...
        #     for seed in seeds
        # }
        # generate_training_cfg(args.config, "train_success", dataset_path_dict, abs_output_dir, seeds, "round_{}_{}".format(i, "ours"))

        # # start training for the next round
        # start_training(abs_output_dir, seeds, "round_{}_{}".format(i, "ours"), cuda_device=args.cuda_device)
