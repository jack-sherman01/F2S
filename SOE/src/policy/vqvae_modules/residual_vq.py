# modified from https://github.com/jayLEE0301/vq_bet_official/blob/main/vector_quantize_pytorch/residual_vq.py
...
from policy.vqvae_modules.vector_quantize_pytorch import VectorQuantize
